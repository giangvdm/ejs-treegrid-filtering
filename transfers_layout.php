...
<Grid>
   ...
   <Cfg id='Production document' SuppressAnimations='1'  Size="Low" Style='White' MainCol='document_type' ShowDeleted='1'/>
   ...
   <Cfg Paging="3"  ChildPaging='3' ColPaging="2" PageLengthDiv="10" FastPages="100" PageTime='10' ChildParts="2" MaxPages='1' PageLength="100" Expanded='0' AllPages='1' />
   <Cfg CopyPasteTree ='3'/>
   <Cfg Alternate='2'/>   
   ...
   <Def>   
      ...
      <D Name='Node' Parent='#Body' CDef='Data' Sorted='1' AcceptDef='Data' Spanned='1' Calculated='1' Expanded='1' CanFilter='1' 
